...
const express = require("express") //untuk mengambil/menggunkan library express
const app = express ()  
...
app.put("/:id_transaksi", async (request,response) => {
    //tampung data untuk update data ke tabel transaksi
        let dataTransaksi = {
         id_member: request.body.id_member,
         tgl: request.body.tgl,
         batas_waktu: request.body.batas_waktu,
    ...
    //tampung data parameter id_transaksi
    let parameter = {
        id_transaksi: request.params.id_transaksi
    }
    //seteah berhasil insery ke tabel transaksi,
    //data detail transaksinya yang lama dihapus semua berdaarkan id transaksinya
...
//enpoint untuk mengubah status transakasi
...
//enpoint mengubah status pembayaran
app.get("/bayar/:id_transaksi", (request, response) => {
    ...
    //proses ubah transakasi
    transaksi.update(data, (request,response))
    .then( result => {
        return response.json({
